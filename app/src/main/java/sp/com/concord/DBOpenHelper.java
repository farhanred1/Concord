...
public class DBOpenHelper  extends SQLiteOpenHelper {
    ...
    private static final String CREATE_EVENTS_TABLE = "create table "+DBStructure.EVENT_TABLE_NAME+"(ID INTEGER PRIMARY KEY AUTOINCREMENT, "
            +DBStructure.FROM +" TEXT,"+DBStructure.TO+" TEXT, "+DBStructure.DATE+" TEXT, " +DBStructure.MONTH+" TEXT,"
    ...
    public void SaveEvent(String event, String time , String date, String month, String year, SQLiteDatabase database) {
        ...
        contentValues.put(DBStructure.FROM,event);
        contentValues.put(DBStructure.TO,time);
    ...
    public Cursor ReadEvents(String date, SQLiteDatabase database) {
        String [] Projection = {DBStructure.FROM,DBStructure.TO,DBStructure.DATE,DBStructure.MONTH,DBStructure.YEAR};
